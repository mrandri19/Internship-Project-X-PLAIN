  ...
  return (
    <Container>
      <Row className="mt-3 d-flex align-items-center">
        <h2 className="p-2">Mispred Instances</h2>
        <Button variant="dark" disabled={(selectedInstance === null) || (selectedClass === null)}
                className="ml-auto p-2"
                onClick={postInstance(selectedInstance, selectedClass)}>Get Explanation</Button>
      </Row>
      <Row>
        <Col lg={9}>
