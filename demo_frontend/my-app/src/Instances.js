...
import {MyTable, makeColumns, makeClasses, makeInstances} from "./MyTableFunctions"
...
function Instances() {
  ...
  const buttondict={"explain": "Get Explanation",
    ...
    <Container>
      <Row className="mt-3 d-flex align-items-center">
        ...
        <Button disabled={(selectedInstance === null) || (selectedClass === null)}
                ...
                variant="dark"
                onClick={postInstance(selectedInstance, selectedClass)}>{buttondict[analysis_type]}</Button>
      </Row>
      <Row>
        <Col lg={9}>
